...
/*==================== IMAGE HOVER EFFECTS ====================*/
// Track mouse position for image hover effects
...
/*==================== SCROLL-BASED CLOUD MOVEMENT ====================*/
// Track scroll position for cloud movement
document.addEventListener('DOMContentLoaded', function() {
  let ticking = false;
  ...
  function updateCloudPosition() {
    ...
    const offset1 = scrollY * 0.5; // Slower movement
    const offset2 = scrollY * 0.8; // Faster movement
    
    // Update CSS custom properties
    document.documentElement.style.setProperty('--scroll-offset', offset1 + 'px');
    document.documentElement.style.setProperty('--scroll-offset-2', offset2 + 'px');
...
// Enhancement: Auto-update footer year
...
document.addEventListener('DOMContentLoaded', function() {
  // Award image modal popup
  const awardImgs = document.querySelectorAll('.award-img');
  ...
  awardImgs.forEach(img => {
    img.addEventListener('click', function() {
      awardModalImg.src = this.src;
      awardModalImg.alt = this.alt;
      awardModal.classList.add('show');
    });
  });

  awardModalClose.addEventListener('click', function() {
